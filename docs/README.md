...
- 📥 Download last version:
  [v1.0.2_x64](https://github.com/roob-p/SuperAdminLauncher/releases/download/v1.0.2/SuperAdminLauncher.Installer_x64.exe)
  [v1.0.2_x86](https://github.com/roob-p/SuperAdminLauncher/releases/download/v1.0.2/SuperAdminLauncher.Installer_x86.exe)
